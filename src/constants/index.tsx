...
export const GRID_ITEMS = [
  {
    ...
    description: "",
    className: "lg:col-span-6 lg:row-span-2 lg:min-h-[60vh]",
  ...
  },
  {
    ...
    titleClassName: "justify-center lg:justify-start lg:justify-center",
    img: "/b5.svg",
    spareImg: "/grid.svg",
  },
  {
    ...
    className: "lg:col-span-3 lg:row-span-1",
    imgClassName: "",
    titleClassName: "justify-center lg:max-w-full max-w-60 text-center",
    img: "",
    spareImg: "",
  },
];
